...
class PhoneBook { // 내가 만드는 자료형
	...
	// 기능 (member method)
	// 메서드 내부에서는 멤버 필드를 조건없이 자유롭게 참조할 수있다
	void show() { // 반환형 함수이름 쓰면 됨
		String form = "%s (%d) : %s";
	...
	// 생성자를 오버로딩(중복정의)하여, 매개변수를 전달하지 않아도 객체를 생상할 수 있게 한다
	PhoneBook() {
	}
}
...
public class Ex05 {
	...
	public static void main(String[] args) {
		...
		// 필드에 접근하여 값을 출력할 수도 있지만, 만들어둔 기능이 있으면 함수를 호출 할 수 있다
		ob1.show(); // 소괄호 붙으면 무조건 함수
		...
		PhoneBook ob3 = new PhoneBook("나단비 =", 5, "010-34343-3434");
