...
class Test1{
	...
	public Test1(String name, int age){ // 객체는 누구든지 접근 가능함
		this.name = name; // private라도 클래스 내에서는 접근이 가능함
		this.age = age;
	}
...
public class Ex01 {
	public static void main(String[] args) {
		...
		//protected : 같으 패키지 + 다른 패키지이더라도 상속관계에 있으면 허용
		//public : 모든 클래스로부터의 접근 허용
