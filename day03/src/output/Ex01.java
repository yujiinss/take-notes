...
public class Ex01 {
	...
	public static void main(String[] args) {
		...
		// System.out.println() : 괄호 안에 하나의 값을 받아서 출력한다
		// System.out.print() : 괄호 안에 하나의 값을 받아서 출력한다. 줄을 바꾸지 않는다
		// System.out.printf() : 괄호 안에 서식과 값을 차례대로 전달받아서 출력한다
		
		System.out.println("a +aa"); // 연산자는 값을 만들어내는 기호이기때문에
		System.out.println("b");     // 괄호 안의 계산이 먼저 진행되고
		...
		for(int i =0; i<5; i++) {
			System.out.print(i + " "); //i를 출력하고 한칸 띄워쓰기하고 줄은 바꾸지 않기
		}
		System.out.println();// 출력이 다 끝나면 줄 바꾸기
		for(int i =0; i<5; i++) {
			System.out.println(i); //  값을 출력할때 마다 게속 줄 바꾸기
		}
